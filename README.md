...
In hindsight I think the Steering Agent may have had better results without being trained with Euclidean distance as an input. Probably just the normal directions would have been enough information.
