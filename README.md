...
- ~~Try some networks in Tensorflow Keras, FNN with ADAM and a CNN.~~ _(the Keras version [keras_main.c](keras_main.c) trains one network with two tanh outputs, one for steering and one for speed.)_
